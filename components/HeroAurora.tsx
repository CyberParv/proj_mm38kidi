...
export default function HeroAurora({
  badge = "Spring Sale • Up to 40% off",
  headline = "Elevate everyday essentials with curated picks",
  subheadline = "Shop premium home, tech, and lifestyle goods with fast shipping and easy returns.",
