...
export default function CTASparkles({
  headline = "Ready for exclusive member perks?",
  description = "Join NovaMart+ to unlock VIP pricing, free express shipping, and early access to launches.",
  ctaLabel = "Join NovaMart+",
  ctaHref = "/membership",
